...
export type ParametersWithResolver<T extends (...args: any) => any> = T extends (
    ...args: infer P
  ) => any
  ? WrapWithResolver<P>
  : never;
...
export type MethodArgs<T extends ClassOf<any>,
  K extends keyof InstanceType<T>> = ParametersWithResolver<InstanceType<T>[K]>;
 ...
 *  - else any
 */
export type ResolvedType<Custom = void,
  Name extends ResolverName = ResolverName> = Name extends ClassOf<any>
  ? InstanceType<Name>
